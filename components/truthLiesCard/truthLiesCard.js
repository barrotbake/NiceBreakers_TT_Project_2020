            ...
            <div className = {styles.TnFCard}>
                ...
                <div>
                    <div className = {styles.firstTwo}>
                        <button 
                        onClick={this.handleClickCard1} 
                        className = {styles.choices}
                        >{this.state.card1.text}</button>
                        <button 
                        onClick={this.handleClickCard2} 
                        className = {styles.choices}
                        >{this.state.card2.text}</button>
                    </div>
                    <div>
                    <div className = {styles.last}>
                        <button 
                        onClick={this.handleClickCard3} 
                        className = {styles.choices}>{this.state.card3.text}</button>
                    </div>
                    </div>
                </div>
            </div>
